...
def get_planner_prompt() -> str:
    ...
    return (
        ...
        "如果用户询问某个推理目标依赖哪些关系、去掉哪条关系就推不出来、哪些关系是必要条件、小故或冗余关系，优先选择 analyze_relation_necessity。"
...
def get_answer_prompt() -> str:
    return (
        ...
        "如果 tool_result 来自 analyze_relation_necessity，应说明目标关系当前是否可推导，哪些底层关系是必要小故，哪些是效率小故，哪些是冗余关系。"
